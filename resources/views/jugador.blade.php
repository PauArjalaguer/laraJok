...
<a href="/desa/jugador/{{$playerInfo[0]->idPlayer}}"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline w-6 hover:text-slate-500 cursor-pointer {{$checkIfSaved==1 ? 'text-red-800':''}}">
