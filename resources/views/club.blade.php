...
<div class="w-full text-slate-700 text-xl mb-4 font-bold pb-2 border-b border-slate-400">
    <a href="/desa/club/{{$clubInfo[0]->idClub}}">
        <svg xmlns="http://www.w3.org/2000/svg" fill={{$checkIfSaved==1 ? 'currentColor':'none'}} viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline w-6 hover:text-slate-500 cursor-pointer {{$checkIfSaved==1 ? 'text-red-800':''}}">
