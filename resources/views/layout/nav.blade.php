<nav class="flex">
    ...
    <div class=" py-1 w-10/12 text-right text-slate-700 bg-graeen-700 flex justify-end">
        ...
        <ul class="p-2 block  hidden lg:inline" id="menu">
            ...
            <li class="block lg:inline lg:p-2 cursor-pointer font-bold text-base ">Contacte</li>
            <li class="block lg:inline p-  cursor-pointer font-bold mt-2 lg:mr-2 ">
                <div class='hidden bg-slate-200 rounded-xl  p-2  w-full   inline text-center' id="searchBarButton" onClick="(()=>{this.style.display='none'; document.getElementById('searchBar').style.display='inline'})()">

                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 inline ">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m15.75 15.75-2.489-2.489m0 0a3.375 3.375 0 1 0-4.773-4.773 3.375 3.375 0 0 0 4.774 4.774ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>
                </div>
                <div class='bg-slate-400 rounded-xl p-3 md:p-2 w-full inline border-solid border-2 border-slate-500' id="searchBar">
            ...
            @if (!Auth::check())
            <li class="block lg:inline mt-4 p-2 cursor-pointer font-bold bg-slate-700 rounded-xl  border-2 border-slate-700 text-white text-center">
                <a href='/dashboard'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 inline">
...
@if (!Auth::check())
<div class='flex rounded-xl mt-2 bg-slate-200 p-2 px-4'>
    <div class='w-11/12'>
    ...
    <div class='w-1/12 text-right flex justify-end cursor-pointer'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
