...
echo "<h1 class=\"font-bold text-xl text-slate-700 mt-4 bg-slate-200 p-2 px-4 rounded-xl\"><a href=\"/register\" class='text-slate-900'>Registra't</a> o <a href=\"/login\" class='text-slate-900'>accedeix</a> per a guardar els teus accessos directes.</h1>";
}
@endphp
<div class="w-full flex my-2">
    @foreach($userSavedData as $userData)
    @php
    // $label =$userData->groupName.$userData->teamName.$userData->playerName.$userData->clubName;
