...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-7 my-4 items-start">
    ...
    <div class="col-span-1 lg:col-span-3">
        <div class="flex items-center justify-between pb-2 border-b border-stone-200 dark:border-stone-800 mb-4 px-0.5">
            ...
            <span class="hallmark-stamp bg-stone-100 text-stone-700 border border-stone-200/80 dark:bg-[#d4ff00] dark:text-black dark:border-transparent">AGENDA</span>
        </div>
    ...
    <div class="col-span-1 lg:col-span-6">
        <div class="flex items-center justify-between pb-2 border-b border-stone-200 dark:border-stone-800 mb-4 px-0.5">
            ...
            <a href="/noticies" class="font-display text-[11px] font-bold text-stone-500 dark:text-stone-400 hover:text-stone-900 dark:hover:text-[#d4ff00] uppercase">Més Notícies →</a>
        </div>
        ...
        <div class="mt-7">
            <div class="flex items-center justify-between pb-2 border-b border-stone-200 dark:border-stone-800 mb-3 px-0.5">
                ...
                <a href="/merchandising" class="font-display text-[11px] font-bold text-stone-500 hover:text-stone-900 dark:hover:text-[#d4ff00] uppercase">Botiga →</a>
            </div>
    ...
    <div class="col-span-1 lg:col-span-3">
        <div class="flex items-center justify-between pb-2 border-b border-stone-200 dark:border-stone-800 mb-2 px-0.5">
            ...
            <span class="hallmark-stamp bg-stone-100 text-stone-700 border border-stone-200/80 dark:bg-[#d4ff00] dark:text-black dark:border-transparent">CERCA RÀPIDA</span>
        </div>
        ...
        <div class="mt-7">
            <div class="flex items-center justify-between pb-1 border-b border-stone-200 dark:border-stone-800 mb-3 px-0.5">
                ...
                <a href="/anuncis" class="font-display text-[10px] font-bold text-stone-700 dark:text-stone-300 hover:text-[#d4ff00] uppercase">Veure Tots →</a>
            </div>
            ...
            <div x-data="{ 
                ...
                <div x-ref="carousel" class="w-full flex gap-3 overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-hide py-1">
                    @forelse($recentAds as $ad)
                        ...
                        @endphp
                        <a href="{{ route('anuncis.show', ['id' => $ad->id, 'slug' => $ad->slug]) }}" class="snap-start flex-shrink-0 w-[47%] bg-white dark:bg-[#121215] border border-stone-200 dark:border-stone-800 rounded-2xl overflow-hidden shadow-xs hover:border-[#d4ff00] transition-all flex flex-col">
                ...
                <!-- Controls -->
                <button @click="scrollPrev()" class="absolute left-1 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-white/90 dark:bg-black/90 border border-stone-300 dark:border-stone-800 flex items-center justify-center text-stone-800 dark:text-stone-200 shadow-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-[#d4ff00] hover:text-black focus:outline-none">
                    <i class="fa-solid fa-chevron-left text-xs"></i>
                </button>
                <button @click="scrollNext()" class="absolute right-1 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-white/90 dark:bg-black/90 border border-stone-300 dark:border-stone-800 flex items-center justify-center text-stone-800 dark:text-stone-200 shadow-md opacity-0 group-hover:opacity-100 transition-opacity hover:bg-[#d4ff00] hover:text-black focus:outline-none">
                    <i class="fa-solid fa-chevron-right text-xs"></i>
                </button>
            </div>
        </div>
