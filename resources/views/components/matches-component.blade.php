 <div class="mb-2 shadow-md shadow-slate-700 mt-2">
     <div class="bg-slate-700 w-full  border-[2px] border-b-[0px] border-slate-700 flex ">
     ...
     <div class="bg-white w-full h-full hover:bg-slate-50 transition-all   flex text-sm items-center">
         ...
         <div class="py-4 px-2 w-2/12 text-center bg-slate-600 text-white  h-full">
