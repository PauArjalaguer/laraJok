<h1 class="font-bold text-xl text-neutral-700">Notícies</h1>
<div class="w-full">
    @php
    $counter=0;
    @endphp
    ...
    <div id="slider{{$counter}}" class="rounded-xl relative mt-2 shadow-xl relative  w-full bg-cover bg-center flex justify-center items-center  overflow-hidden  transition-all duration-500  ease-in-out ">
        <div class='bg-neutral-100 w-full h-full  p-24 lg:p-56 transition-all duration-1000 ease-in-out transform bg-center bg-cover hover:scale-105 cursor-pointer'
        ...
        <div class="absolute flex flex-col justify-center items-center w-full text-xl font-black transition-all duration-500 ease-in-out transform text-gray-50 top-12 lg:top-48 ">
            <a href='' class="text-center text-xl lg:text-3xl text-white font-bold [text-shadow:_0_2px_2px_rgb(0_0_0_/_100%)] shadow-neutral-700 lg:mb-8 ">
                {{substr($news->newsTitle,0,120)}}</a>
            <a class="shadow-md shadow-neutral-700 bg-neutral-600 px-4 lg:px-12 py-2 bg-gradient-to-t from-neutral-400 to-neutral-500 hover:from-neutral-400 hover:to-neutral-600 text-sm lg:text-xl text-white font-semibold drop-shadow-lg rounded-full" href="/noticies/detall/{{$news->idNew}}/El%20j%C3%BAnior%20a%20la%20final%20de%20la%20Copa%20Federaci%C3%B3">Veure notícia</a>
...
<div class='mt-2'>
    <div id='sliderBall_0' class='border border-solid border-neutral-400 bg-neutral-700 w-[12px] h-[12px] text-center rounded-[50%] float-left mr-1 transition-all duration-1500 ease-in-out transform'>&nbsp;</div>
    <div id='sliderBall_1' class='border border-solid border-neutral-400 bg-neutral-700 w-[12px] h-[12px] text-center rounded-[50%] float-left mr-1 transition-all duration-1500 ease-in-out transform'>&nbsp;</div>
    <div id='sliderBall_2' class='border border-solid border-neutral-400 bg-neutral-700 w-[12px] h-[12px] text-center rounded-[50%] float-left mr-1 transition-all duration-1500 ease-in-out transform'>&nbsp;</div>
    <div id='sliderBall_3' class='border border-solid border-neutral-400 bg-neutral-700 w-[12px] h-[12px] text-center rounded-[50%] float-left transition-all duration-1500 ease-in-out transform'>&nbsp;</div>
