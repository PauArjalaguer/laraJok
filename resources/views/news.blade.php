...
<div onClick='location.href = "/noticies/detall/{{$news->idNew}}/{{$news->newsTitle}}"' class='md:flex border border-solid border-0 border-b-[0px] border-b-slate-300  md:pb-4 md:mt-4 '>
    <div class=" relative mt-2 hover:shadow-xl shadow-slate-400 z-10 relative  w-full  md:w-1/2 lg:w-1/4 
    ...
    <div class=' md:w-1/2 lg:w-3/4 md:pl-4 mt-2 lg:mt-0'>
        <div class='text-sm lg:text-xl text-slate-900 font-bold flex-nowrap md:float-left mb-1 mt-4 md:mt-0 '>
        ...
        <h2 class='mb-1 text-slate-800 text-xs lg:text-base'>{{$news->newsSubtitle}}</h2>
