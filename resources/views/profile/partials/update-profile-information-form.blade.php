<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Actualitza la informació del teu perfil d'usuari i la teva adreça de correu electrònic.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="name" :value="__('Nom i cognoms')" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('Desar canvis') }}</x-primary-button>
