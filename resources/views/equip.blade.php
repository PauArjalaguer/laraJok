...
<div class="w-full text-slate-700 text-xl my-4 font-bold pb-2 border-b border-slate-400">
   <a href="/desa/equip/{{$teamInfo[0]->idTeam}}"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline w-6 hover:text-slate-500 cursor-pointer {{$checkIfSaved==1 ? 'text-red-800':''}}">
