...
class Players extends Model
{
    ...
    {
        $result = Players::distinct("playerName")->select('players.idPlayer', 'playerName','number')->join("player_match", "player_match.idPlayer", "=", "players.idPlayer")->orderBy('playerName', 'asc')
